...
```bash
mv ~/Projects/github.com/smykla-skalski/.dotfiles ~/Projects/github.com/smykla-skalski/.dotfiles.backup
curl -fsSL https://smyk.la | bash
```
...
```bash
ls -la ~/Projects/github.com/smykla-skalski/.dotfiles/.git/age-*.sh
```
